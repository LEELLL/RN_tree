...
from miniimagenet_train_one_shot import args
...
def mini_imagenet_folders():
    # train_folder = '/media/dm/d/LearningToCompare_FSL-master/datas/miniImagenet/train'
    # test_folder = '/media/dm/d/LearningToCompare_FSL-master/datas/miniImagenet/test'
    train_folder = args.datas_name_or_path + 'train'
    test_folder = args.datas_name_or_path + 'test'
...
class MiniImagenetTask(object):
    ...
    def get_class(self, sample):
        ...
        getclass = '/' + os.path.join(*sample.split('/')[:-1])
        return getclass
